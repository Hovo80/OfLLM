// gl4-core-public/src/types.rs
// Fixed-point типы для GL4 - без fp32, для ZKML 1 constraint вместо 32
// Author: Martirosyan Hovhannes - Gayane Soft
// Types: Gl4Digit (4-bit), Q1_15, Q1_31 (RoPE), Q4_28, Q2_6 (KV-cache), Q4_60 (Adam)

#![allow(dead_code)]

/// Gl4Digit - 4-битное 0..15, хранит Q1.3 или знаковое -8..7
/// Упаковка: 2 тетрады в 1 байте = 2x экономия RAM
pub type Gl4Digit = u8;

/// Q1_15: 1 знак + 15 дробных, -1..0.999, SCALE=32767
/// Для весов attention, активаций
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(transparent)]
pub struct Q1_15(pub i16);

/// Q1_31: 1 знак + 31 дробных, SCALE=2147483647
/// Для RoPE sin/cos, 1 mul = 1 constraint в ZKML вместо 32 для fp32
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(transparent)]
pub struct Q1_31(pub i32);

/// Q4_28: 4 целых + 28 дробных, -8..7.999
/// Для аккумуляции dot product, Q20Accum
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(transparent)]
pub struct Q4_28(pub i32);

/// Q2_6: 2 целых + 6 дробных, -2..1.98, 1 байт i8
/// Для KV-cache - 4x экономия RAM
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(transparent)]
pub struct Q2_6(pub i8);

/// Q4_60: 4 целых + 60 дробных, i64, для Adam моментов, только train
/// В инференсе не используется, только в q20-private (не публиковать)
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(transparent)]
